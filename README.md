About djangorestframework-filters
=================================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/djangorestframework-filters-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9223&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/djangorestframework-filters-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `djangorestframework-filters` can be installed with:

```
conda install djangorestframework-filters
```

It is possible to list all of the versions of `djangorestframework-filters` available on your platform with:
